...
Item {
    ...
    //1000 - x 800 - y
    property int sampleColumns: settings.columns //x
    property int sampleRows: settings.rows //y
    property int sampleCache: settings.cache //глубина прорисовки
    ...
    Item {
        ...
        Surface3D {
            ...
            axisX.labelFormat: settings.labelAxisX
            axisY.labelFormat: settings.labelAxisY
            axisZ.labelFormat: settings.labelAxisZ
            axisX.min: settings.minX
            axisY.min: settings.minY
            axisZ.min: settings.minZ
            axisX.max: settings.maxX
            axisY.max: settings.maxY
            axisZ.max: settings.maxZ
            axisX.segmentCount: settings.gridX//сетка по осям
            axisY.segmentCount: settings.gridY
            axisZ.segmentCount: settings.gridZ
            measureFps: true
